package com.cognitivabrasil.feb.obaa;
...
public class OaiOBAAIT {
    ...
    public void testDetectOAIError() throws FileNotFoundException {
        OaiOBAA l;
        try {
            l = OaiOBAA.fromFilename("./src/test/resources/metadata/oai_error.xml");
    ...
    public void testDetectOAICannotDisseminate() throws FileNotFoundException {
        ...
        try {
            l = OaiOBAA
                    .fromFilename("./src/test/resources/metadata/oai_cannot_disseminate.xml");
    ...
    public void testDetectOAINoRecords() throws FileNotFoundException {
        ...
        OaiOBAA l = OaiOBAA
                .fromFilename("./src/test/resources/metadata/oai_norecords.xml");
    ...
    public void testDetectOAINoRecords2() throws FileNotFoundException {
        try {
            OaiOBAA l = OaiOBAA
                    .fromFilenameWithUrl("./src/test/resources/metadata/oai_norecords2.xml", "www.null.pointer");
            assertEquals(l.getSize(), 0);
