...
///coletando valores por parametro
                    ...
                    out.print("<p class='textoErro'>Erro! Parametros incorretos</p>");
            ...
            <div class="tituloPrincipal">
                <div class="tituloObj">&diams; 
                    <%
                        if (dados.containsKey("obaaTitle")) {
                            out.println(dados.get("obaaTitle").toString().replaceAll(";; ", "<BR>&diams; "));
                        } else {
                            out.println("T&iacute;tulo n&atilde;o informado.");                            
                        }
                    %>
