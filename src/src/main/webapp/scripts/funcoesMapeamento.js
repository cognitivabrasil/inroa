...
function selecionaMapeamento(idResultado, idPadrao, mapSelecionado)
{
    ...
    ajax.open("GET", "http://localhost:8080"+"/admin/mapeamentos/listaMapeamentoPadraoSelecionado?idpadrao="+idPadrao+"&mapSelecionado="+mapSelecionado, true); // Envia o termo da busca como uma querystring, nos possibilitando o filtro na busca.
