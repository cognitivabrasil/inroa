 ...
 */
@Repository
@Profile({ "default", "oracle", "test"})
public class SearchesOracleDao extends JdbcDaoSupport implements SearchesJdbcDao {
    private static final Logger log = LoggerFactory.getLogger(SearchesOracleDao.class);
