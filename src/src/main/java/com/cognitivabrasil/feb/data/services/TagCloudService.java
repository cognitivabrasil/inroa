...
public interface TagCloudService {
     ...
     *
     * Generates a Map where the keys are the tags and the value is a integer representing the weight of this tag. The
     * absolute value of the Integer is implementation dependent, the relative size is what matters.
     *
     * @return the map
     */
