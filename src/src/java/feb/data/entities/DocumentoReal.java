...
public class DocumentoReal implements java.io.Serializable,
	...
	public List<String> getDate() {
		...
		for (Objeto o : getObjetos()) {
			if (o.getAtributo().equalsIgnoreCase("obaaDate")) {
				l.add(o.getValor().replaceAll("[A-Z,a-z,ê,Ê]", " ")
						.replaceAll(" -", ""));
			}
		}
		return l;
	...
	/**
	 * @param repositorioSubFed
	 *            the repositorioSubFed to set
	 */
	 ...
	 *             if there is no XML metadata associated with the document
	 */
	...
	public List<String> getKeywordsTokenized() {
		if (keywordTokens == null) {
			...
			for (String keyword : getKeywords()) {
				keywordTokens.addAll(Operacoes
						.tokeniza(keyword, getStopWords()));
			}
	...
	public boolean isIndexEmpty() {
		return (getTitles().isEmpty() && getKeywords().isEmpty() && getDescriptions()
				.isEmpty());
	}
