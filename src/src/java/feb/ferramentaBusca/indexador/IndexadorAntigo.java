...
//            tokenDao.save(doc.getTokens());          
    ...
    public void populateR1() {
            ...
            //Adicioanr o codigo do SOLR.
           // Pegar toda a base e reindexar ela e adicionar coisas novas.
//            if (Solr.indexarSolr())
//                System.out.println("\n\n\n\n Sou Recuperador.java: SOLR Indexado!!!");;
//           // server.optimize();
//                
