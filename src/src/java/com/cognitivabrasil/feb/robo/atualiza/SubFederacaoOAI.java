...
public class SubFederacaoOAI {
	 ...
	 *
	 * @param con
	 *            Conex&atilde;o com a base de dados local.
	 * @param indexar
	...
	public boolean pre_AtualizaSubFedOAI(Indexador indexar) {
		...
		try {
			...
			for (SubFederacao subFed : listaSubfed) { // percorre todas as
														// federacoes
														// cadastradas
				...
				if (atualizadoTemp) { // se alguma subfederacao foi atualizada
										// entao seta o atualizou como true
					atualizou = true;
				}
			}
	 ...
	 *
	 * @param idSub
	 *            Id da subfedera&ccedil;&atilde;o na ser atualizada.
	 ...
	 *
	 * @param nome
	 *            ArrayList<String> contendo o nome das federa&ccedil;&otilde;es
