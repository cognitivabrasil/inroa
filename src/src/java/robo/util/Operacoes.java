...
public class Operacoes {
    ...
    /**
     *  Testa se a data recebida Ã© anterior a 01/01/1000. Utilizado para testar se a base de dados deve ser sincronizada do zero ou nÃ£o.
     * @param horaBase hora que serÃ¡ testada
     * @return true ou false. Se a data informada como parÃ¢metro for menor retorna true se nÃ£o false
     */
     ...
     * @return Strign contendo data e hora da ultima atualiza&ccdil;&atilde;o, formatada como: "Dia dd/mm/aaa Ã s hh:mm:ss"
     */
    ...
    /**
     * Informa como uma frase a data e hora da &uacute;ltima atualiza&ccdil;&atilde;o, se a data for inferior a 01/01/1000, um teste para verificar se foi informado um endereÃ§o para atualizaÃ§Ã£o Ã© realizado. Se nÃ£o existir endereÃ§o retorna um aviso, se existir retorna a mensagem: "Ainda n&atilde;o foi atualizado!"
     * @return Strign contendo data e hora da ultima atualiza&ccdil;&atilde;o, formatada como: "Dia dd/mm/aaa Ã s hh:mm:ss"
     */
