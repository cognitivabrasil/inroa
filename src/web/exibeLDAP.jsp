...
<!--Informações Gerais-->
            <div class="subtitulo">Informa&ccedil;&otilde;es sobre o LDAP <%=res.getString("nome")%></div>
            <div class="editar"><a href="./editarLDAP.jsp?id=<%=id%>">Editar</a></div>
            ...
            <div class="LinhaEntrada">
                ...
                <div class="Value">&nbsp;<%=res.getString("dn")%></div>
            </div>
            <div class="LinhaEntrada">
                <div class="Label">
                    Login:
