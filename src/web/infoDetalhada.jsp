...
<html>
    ...
    <body id="bodyLetraMaior">
        ...
        <div id="page">
            ...
            <!--Informacoes gerais-->
            <div class="topicosObj">
                <div class="titulo">Informa&ccedil;&otilde;es Gerais do Objeto</div>
            ...
            <div class="topicosObj">
                <div class="titulo">Informa&ccedil;&otilde;es T&eacute;cnicas Sobre o Objeto</div>
            ...
            <!--Requisitos Tecnicos-->
            <div class="topicosObj">
                <div class="titulo">Requisitos T&eacute;cnicos Para Funcionalidade do Objeto</div>
                <%
                ...
                <div class="valor">&nbsp;
                    <%
                    String obaaType = dados.get("obaaType").toString().trim();
                ...
                <div class="valor">&nbsp; 
                    <%
                    String obaaName = dados.get("obaaName").toString().trim();
...
%>
            ...
            <!--Duracao do objeto-->
            <div class="topicosObj">
                <div class="titulo">Dura&ccedil;&atilde;o do Objeto</div>
            ...
            <div class="topicosObj">
                <div class="titulo">Ciclo de Vida do Objeto</div>
                <%
            ...
            <div class="topicosObj">
                ...
                %>
                <div class="titulo">Contribui&ccedil;&otilde;es Para o Objeto</div>
            ...
            %>
            <div class="topicosObj">
                <div class="titulo">Caracter&iacute;sticas Pedag&oacute;gicas e Educacionais do Objeto</div>
                <%
            ...
            %>
            <div class="topicosObj">
                <div class="titulo">Propriedade Intelectual do Objeto</div>
                <%
            ...
            <div class="topicosObj">
                <div class="titulo">Localiza&ccedil;&atilde;o do Objeto</div>
                ...
                } else if (dados.containsKey("obaaIdentifier")) { //se nao
                    ...
                    for (int i = 0; i < temp.length; i++) { //percorre o array temp
                        if (temp[i].contains("http")) { //se existir a palavra http significa q eh um link
                            if (obaaTemp.isEmpty()) {
                                ...
                                obaaTemp = obaaTemp + ";; " + obaaTemp; //se ja possui algo na string contena o valor com ";; "
                            } //fim else
                        } //fim if http
                    } //fim for temp.length
                ...
                String temp[] = obaaTemp.split(";; ");
                for (int kk = 0; kk < temp.length; kk++) {
                    out.print("<a href='" + temp[kk].trim() + "' target='_new'>" + temp[kk].trim() + "</a>");
