...
public class Principal {
     ...
     */
    public ArrayList<String> buscaXmlRepositorio(String endereco, String dataInicial, String dataFinal, String nomeRepositorio, String dirXML){
...
try{
        ...
        ListRecords listRecords = new ListRecords(endereco,dataInicial,dataFinal,"","oai_dc");
