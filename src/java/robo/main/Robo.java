                        ...
                        if (padraoMetadados.equalsIgnoreCase("Dublin Core")) { //testar em que padrao sera feita a sincrinizacao com o OAI-PMH
                            ...
                            if (caminhoTeste.isDirectory()) {
                                ...
                                try {
                                    ...
                                    caminhoXML = importar.buscaXmlRepositorio(url, ultimaAtualizacao, "9999-12-31T00:00:00Z", nome, caminhoDiretorioTemporario, "oai_dc"); //chama o metodo que efetua o HarvesterVerb grava um xml em disco e retorna um arrayList com os caminhos para os XML
        ...
        try {
            ...
            if (url.isEmpty()) { //testa se a string url esta vazia.
                ...
                if (tipoSinc.equalsIgnoreCase("OAI-PMH")) {
                    ...
                    else if (padraoMetadados.equalsIgnoreCase("obaa")) {
